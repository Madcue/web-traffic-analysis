...
public class AdInfo {
     private String utmCampaign = "-";//活动
     private String utmContent = "-";//内容
     private String utmTerm = "-";//词条
     private String utmSource = "-";//来源
     private String utmMedium = "-";//存储媒介
     //额外加的两个广告参数
     private String utmAdGroup = "-";//ad组
     private String utmChannel = "-";//系列渠道
