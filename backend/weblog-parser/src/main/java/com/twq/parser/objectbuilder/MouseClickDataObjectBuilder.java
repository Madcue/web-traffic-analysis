...
public class MouseClickDataObjectBuilder extends AbstractDataObjectBuilder {
     ...
     private static final int CLICKXBOUNDARY = 10000;
     private static final int CLICKYBOUNDARY = 100000;
     ...
     public List<BaseDataObject> doBuildDataObjects(PreParsedLog preParsedLog) {
          ...
          //点击的链接信息
          mcDataObject.setLinkX(getValidClickXYPoint(getIntValue("lx", reader), CLICKXBOUNDARY, -1 * CLICKYBOUNDARY));
     ...
     private Integer getValidClickXYPoint(int point, int maxBoundaryValue, int minBoundaryValue) {
