...
public class Heartbeat extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public CharSequence server_time;
   ...
   */
  public Heartbeat(CharSequence tracker_version, Integer profile_id, CharSequence user_id, Long server_session_id, CharSequence server_time, Integer loading_duration, CharSequence page_view_id) {
  ...
  public void put(int field$, Object value$) {
    ...
    case 3: server_session_id = (Long)value$; break;
    case 4: server_time = (CharSequence)value$; break;
    case 5: loading_duration = (Integer)value$; break;
    case 6: page_view_id = (CharSequence)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static Builder newBuilder(Heartbeat other) {
    return new Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Heartbeat>
    ...
    private Builder(Heartbeat other) {
            super(Heartbeat.SCHEMA$);
      if (isValidValue(fields()[0], other.tracker_version)) {
        this.tracker_version = data().deepCopy(fields()[0].schema(), other.tracker_version);
        fieldSetFlags()[0] = true;
    ...
    public Heartbeat build() {
      try {
        ...
        record.server_session_id = fieldSetFlags()[3] ? this.server_session_id : (Long) defaultValue(fields()[3]);
        record.server_time = fieldSetFlags()[4] ? this.server_time : (CharSequence) defaultValue(fields()[4]);
        record.loading_duration = fieldSetFlags()[5] ? this.loading_duration : (Integer) defaultValue(fields()[5]);
        record.page_view_id = fieldSetFlags()[6] ? this.page_view_id : (CharSequence) defaultValue(fields()[6]);
        return record;
      } catch (Exception e) {
